/* 5.	El objeto “randomObject” tiene objetos anidados dentro.
Muestra por consola la clave “board” con valor “broken”.
Después, añade un atributo debajo de él con la clave “name” y de valor un nombre que hayas pedido al usuario.  */
...
/* Con Object.keys accedemos a la clave del objeto*/
console.log(Object.keys(randomObject)); // Imprime todas las claves en consola y busco la posición de "board"

/* for (const clave in randomObject) {
  console.log(`${clave}`);
} */

console.log(
  randomObject[
    "randomObjec.speed.past.program.grade.addition.whose.national.cannot"
  ]
);
